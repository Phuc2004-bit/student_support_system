...
try {
    ...
    Copy-Item -LiteralPath (Join-Path $ProjectRoot "RELEASE_NOTES_V1.3.0.md") -Destination $ReleaseDir
    Copy-Item -LiteralPath (Join-Path $ProjectRoot "RELEASE_CHECKLIST_V1.3.0.md") -Destination $ReleaseDir
