...
$ZipName = "StudentSupportSystem-1.1.0-win64.zip"
$ZipPath = Join-Path $ReleaseDir $ZipName
$ChecksumPath = "$ZipPath.sha256"
$Executable = Join-Path $PackageDir "StudentSupportSystem.exe"
$ReleaseNotes = Join-Path $ProjectRoot "RELEASE_NOTES_V1.1.0.md"
$ReleaseChecklist = Join-Path $ProjectRoot "RELEASE_CHECKLIST_V1.1.0.md"
